...
public class Response<T> implements Serializable {
    ...
    public static <T> Response<T> responseMsg(TenantCodeEnum tenantCodeEnum) {
        Response<T> baseResponse = new Response<T>();
        baseResponse.setCode(tenantCodeEnum.getCode());
        baseResponse.setMsg(tenantCodeEnum.getMsg());
        return baseResponse;
    }
